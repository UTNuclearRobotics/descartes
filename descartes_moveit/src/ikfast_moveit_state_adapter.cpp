...
bool descartes_moveit::IkFastMoveitStateAdapter::computeIKFastTransforms()
{
  ...
  {
    ROS_ERROR_NAMED("descartes", "IkFastMoveitStateAdapter: Cannot find transformation to frame '%s' in group '%s'.",
  ...
  ROS_INFO_NAMED("descartes", "IkFastMoveitStateAdapter: initialized with IKFast tool frame '%s' and base frame '%s'.",
